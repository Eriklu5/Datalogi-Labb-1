...
def main():
    ...
    breaking_bad_info = ["Breaking Bad", 9.5, "Bryan Cranstaon, Aaron Paul, Anna Gunn",
                        5.4, "Crime drama, Thriller", "Vince Gilligan", "Vince Gilligan", 2008, 62, "AMC"]
    chernobyl_info = ["Chernobyl", 9.3, "Jared Harris, Jessie Buckley, Stellan Skarsgård",
                    0.5, "Historical drama, Thriller", "Johan Renck", "Craig Mazin", 2019, 5, "HBO"]
